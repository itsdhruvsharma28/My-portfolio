...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-gray-900/95 backdrop-blur-sm border-b border-gray-800 z-40 mx-6">
      <div className="mx-auto px-6 py-4 flex items-center justify-between">
        {/* Logo - Diamond D */}
        <div className="flex items-center">
          <div className="relative w-12 h-12 transform rotate-45  border-2 border-blue-500 rounded-lg p-6 ">
            <div className="w-full h-full "></div>
            <div className="absolute inset-0 flex items-center justify-center transform -rotate-45">
              <span className="text-2xl font-extrabold text-white text-blue-500">
                D
              </span>
            </div>
          </div>
